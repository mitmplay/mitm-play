...
.bgroup-right button {
  ...
  function create_each_block$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			t2 = text(t2_value);
  			t3 = space();
  			attr_dev(summary, "class", "sv-title svelte-jp33b8");
  			add_location(summary, file$1, 11, 2, 216);
  			attr_dev(pre, "class", "sv-" + /*key*/ ctx[2] + " svelte-jp33b8");
  			add_location(pre, file$1, 12, 2, 259);
  			attr_dev(details, "class", "sv-data sv-" + /*key*/ ctx[2] + " svelte-jp33b8");
  ...
  function create_fragment$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			attr_dev(div, "class", "sv-item svelte-jp33b8");
  ...
  // (84:4) {#if lst[item.session].length}
  function create_if_block(ctx) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "if",
  		source: "(84:4) {#if lst[item.session].length}",
  		ctx
  	});
  ...
  function create_else_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(pre, file, 104, 14, 3596);
  		},
  		m: function mount(target, anchor) {
  ...
  // (102:12) {#if i2.meta.general.ext==='json'}
  function create_if_block_1(ctx) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "if",
  		source: "(102:12) {#if i2.meta.general.ext==='json'}",
  		ctx
  	});
  ...
  // (85:6) {#each lst[item.session] as i2}
  function create_each_block_1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(summary0, file, 86, 10, 2682);
  			attr_dev(summary1, "class", "sv-title sv-header svelte-1m2hrrc");
  			add_location(summary1, file, 96, 12, 3215);
  			attr_dev(details0, "class", "sv-row-data sv-header svelte-1m2hrrc");
  			add_location(details0, file, 95, 10, 3162);
  			attr_dev(summary2, "class", "sv-title sv-content svelte-1m2hrrc");
  			add_location(summary2, file, 100, 12, 3419);
  			attr_dev(details1, "class", details1_class_value = "sv-row-data sv-content mt-" + /*i2*/ ctx[14].meta.general.method + " svelte-1m2hrrc");
  			add_location(details1, file, 99, 10, 3337);
  			attr_dev(details2, "class", "sv-rows svelte-1m2hrrc");
  			add_location(details2, file, 85, 8, 2645);
  		},
  		m: function mount(target, anchor) {
  		...
  		p: function update(ctx, dirty) {
  			...
  			if (!current || dirty & /*lst, obj*/ 3 && details1_class_value !== (details1_class_value = "sv-row-data sv-content mt-" + /*i2*/ ctx[14].meta.general.method + " svelte-1m2hrrc")) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(85:6) {#each lst[item.session] as i2}",
  		ctx
  	});
  ...
  function create_each_block(ctx) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(79:0) {#each obj.rows as item}",
  		ctx
  	});
