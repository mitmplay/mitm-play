...
.bgroup-topr span {
  font-size: 14px;
	...
	function create_if_block_6(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(a, file$4, 119, 10, 3575);
			},
			m: function mount(target, anchor) {
		...
		dispatch_dev("SvelteRegisterBlock", {
			...
			type: "if",
			source: "(119:8) {#if criterion1[tag]}",
			ctx
		});
	...
	// (129:6) {#each Object.entries(criterion2) as [key, value]}
	function create_each_block_2(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(a, file$4, 129, 8, 3840);
			},
			m: function mount(target, anchor) {
				insert_dev(target, a, anchor);
				append_dev(a, t0);
		...
		dispatch_dev("SvelteRegisterBlock", {
			...
			type: "each",
			source: "(129:6) {#each Object.entries(criterion2) as [key, value]}",
			ctx
		});
	...
	// (136:6) {#if all.length||any.length}
	function create_if_block$2(ctx) {
		...
		const block = {
			c: function create() {
				...
				t2 = space();
				hr1 = element("hr");
				add_location(hr0, file$4, 136, 8, 4136);
				attr_dev(div, "class", "pre svelte-tj161o");
				add_location(div, file$4, 137, 8, 4150);
				add_location(hr1, file$4, 161, 8, 4817);
			},
			m: function mount(target, anchor) {
		...
		dispatch_dev("SvelteRegisterBlock", {
			...
			type: "if",
			source: "(136:6) {#if all.length||any.length}",
			ctx
		});
	...
	function create_if_block_4(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(b, file$4, 148, 12, 4470);
				attr_dev(ol, "class", "svelte-tj161o");
				add_location(ol, file$4, 149, 12, 4515);
			},
			m: function mount(target, anchor) {
	...
	function create_if_block_2$1(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(b, file$4, 139, 12, 4207);
				attr_dev(ol, "class", "svelte-tj161o");
				add_location(ol, file$4, 140, 12, 4252);
			},
			m: function mount(target, anchor) {
				insert_dev(target, b, anchor);
				insert_dev(target, t1, anchor);
	...
	function create_each_block_1$2(ctx) {
		...
		const block = {
			c: function create() {
				li = element("li");
				add_location(li, file$4, 151, 14, 4565);
			},
			m: function mount(target, anchor) {
	...
	function create_each_block$4(ctx) {
		...
		const block = {
			c: function create() {
				li = element("li");
				add_location(li, file$4, 142, 14, 4302);
			},
			m: function mount(target, anchor) {
				insert_dev(target, li, anchor);
				li.innerHTML = raw_value;
	...
	// (158:10) {#if incomplete && grp==='color-contrast'}
	function create_if_block_1$2(ctx) {
		...
		dispatch_dev("SvelteRegisterBlock", {
			...
			type: "if",
			source: "(158:10) {#if incomplete && grp==='color-contrast'}",
			ctx
		});
	...
	function create_fragment$4(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(path, file$4, 108, 6, 2755);
				attr_dev(g, "id", "surface1");
				add_location(g, file$4, 107, 6, 2731);
				attr_dev(svg, "width", "16px");
				attr_dev(svg, "height", "16px");
				attr_dev(svg, "viewBox", "0 0 16 16");
				attr_dev(svg, "version", "1.1");
				add_location(svg, file$4, 106, 4, 2658);
				attr_dev(span0, "class", "icopied svelte-tj161o");
				add_location(span0, file$4, 111, 4, 3346);
				attr_dev(span1, "class", "icopy svelte-tj161o");
				add_location(span1, file$4, 105, 2, 2615);
				attr_dev(h4, "class", "svelte-tj161o");
				add_location(h4, file$4, 114, 4, 3438);
				attr_dev(p0, "class", "svelte-tj161o");
				add_location(p0, file$4, 115, 4, 3458);
				add_location(b0, file$4, 116, 17, 3496);
				attr_dev(p1, "class", "tgs svelte-tj161o");
				add_location(p1, file$4, 116, 4, 3483);
				add_location(b1, file$4, 127, 6, 3758);
				attr_dev(a, "target", "_blank");
				attr_dev(a, "rel", "noopener noreferrer");
				attr_dev(a, "href", /*helpUrl*/ ctx[7]);
				add_location(a, file$4, 131, 6, 3944);
				attr_dev(p2, "class", "svelte-tj161o");
				add_location(p2, file$4, 126, 4, 3748);
				add_location(b2, file$4, 134, 15, 4059);
				attr_dev(summary, "class", "svelte-tj161o");
				add_location(summary, file$4, 134, 6, 4050);
				attr_dev(code, "class", "language-html svelte-tj161o");
				add_location(code, file$4, 164, 13, 4870);
				attr_dev(pre, "class", "svelte-tj161o");
				add_location(pre, file$4, 164, 8, 4865);
				attr_dev(div0, "class", "pre svelte-tj161o");
				add_location(div0, file$4, 163, 6, 4841);
				details.open = true;
				attr_dev(details, "class", "svelte-tj161o");
				add_location(details, file$4, 133, 4, 4029);
				attr_dev(div1, "class", "a11y-content");
				add_location(div1, file$4, 113, 2, 3407);
				attr_dev(div2, "class", "a11y-popup svelte-tj161o");
				attr_dev(div2, "style", /*style*/ ctx[2]);
				add_location(div2, file$4, 104, 0, 2580);
			},
