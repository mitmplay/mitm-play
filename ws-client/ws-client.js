  ...
  function create_each_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(td0, file, 62, 8, 1376);
  			attr_dev(td1, "class", "kcode svelte-14inhhw");
  			add_location(td1, file, 63, 8, 1411);
  			attr_dev(td2, "class", "title svelte-14inhhw");
  			add_location(td2, file, 66, 8, 1497);
  			attr_dev(tr, "class", "svelte-14inhhw");
  			add_location(tr, file, 61, 6, 1362);
  		},
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(61:4) {#each _keys as obj,i}",
  		ctx
  	});
  ...
  function create_fragment(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(b, file, 58, 2, 1299);
  			attr_dev(table, "class", "svelte-14inhhw");
  			add_location(table, file, 59, 2, 1319);
  			attr_dev(div, "class", "vbox svelte-14inhhw");
  			add_location(div, file, 57, 0, 1277);
  		},
