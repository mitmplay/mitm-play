  ...
  function create_each_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			t4 = text(t4_value);
  			t5 = space();
  			attr_dev(td0, "class", "no svelte-19dlt2p");
  			add_location(td0, file, 43, 8, 893);
  			attr_dev(td1, "class", "kcode svelte-19dlt2p");
  			add_location(td1, file, 44, 8, 928);
  			attr_dev(td2, "class", "title svelte-19dlt2p");
  ...
  function create_fragment(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			attr_dev(table, "class", "svelte-19dlt2p");
  			add_location(table, file, 40, 2, 836);
  			attr_dev(div, "class", "vbox svelte-19dlt2p");
