...
.bgroup-right button {
  ...
  function create_each_block$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			t2 = text(t2_value);
  			t3 = space();
  			attr_dev(summary, "class", "sv-title svelte-tqqn7t");
  			add_location(summary, file$1, 11, 2, 216);
  			attr_dev(pre, "class", "sv-" + /*key*/ ctx[2] + " svelte-tqqn7t");
  			add_location(pre, file$1, 12, 2, 259);
  			attr_dev(details, "class", "sv-data sv-" + /*key*/ ctx[2] + " svelte-tqqn7t");
  ...
  function create_fragment$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			attr_dev(div, "class", "sv-item svelte-tqqn7t");
  ...
  function create_else_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			pre = element("pre");
  			t = text(t_value);
  			attr_dev(pre, "class", "svelte-1mbw9mc");
  			add_location(pre, file, 101, 14, 3301);
  		},
  		m: function mount(target, anchor) {
  ...
  // (99:12) {#if i2.meta.general.ext==='json'}
  function create_if_block_1(ctx) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "if",
  		source: "(99:12) {#if i2.meta.general.ext==='json'}",
  		ctx
  	});
  ...
  function create_each_block_1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			if_block.c();
  			t11 = space();
  			attr_dev(span0, "class", span0_class_value = "sv-" + /*i2*/ ctx[14].meta.general.status + " svelte-1mbw9mc");
  			add_location(span0, file, 88, 12, 2603);
  			attr_dev(span1, "class", span1_class_value = "sv-" + /*i2*/ ctx[14].meta.general.method + " svelte-1mbw9mc");
  			add_location(span1, file, 89, 12, 2688);
  			attr_dev(span2, "class", span2_class_value = "sv-" + (/*path*/ ctx[3] ? 'path' : 'fullpath') + " svelte-1mbw9mc");
  			add_location(span2, file, 90, 12, 2787);
  			...
  			attr_dev(summary0, "class", summary0_class_value = "sv-title st" + Math.trunc(/*i2*/ ctx[14].meta.general.status / 100) + "x" + " svelte-1mbw9mc");
  			add_location(summary0, file, 83, 10, 2415);
  			attr_dev(summary1, "class", "sv-title sv-header svelte-1mbw9mc");
  			add_location(summary1, file, 93, 12, 2948);
  			attr_dev(details0, "class", "sv-row-data sv-header svelte-1mbw9mc");
  			add_location(details0, file, 92, 10, 2895);
  			attr_dev(summary2, "class", "sv-title sv-content svelte-1mbw9mc");
  			add_location(summary2, file, 97, 12, 3124);
  			attr_dev(details1, "class", "sv-row-data sv-content svelte-1mbw9mc");
  			add_location(details1, file, 96, 10, 3070);
  			attr_dev(details2, "class", "sv-rows svelte-1mbw9mc");
  			add_location(details2, file, 82, 8, 2378);
  		},
  		m: function mount(target, anchor) {
  		...
  		p: function update(ctx, dirty) {
  			...
  			if (!current || dirty & /*lst, obj*/ 3 && span0_class_value !== (span0_class_value = "sv-" + /*i2*/ ctx[14].meta.general.status + " svelte-1mbw9mc")) {
  				attr_dev(span0, "class", span0_class_value);
  			}

  			if ((!current || dirty & /*lst, obj*/ 3) && t2_value !== (t2_value = /*i2*/ ctx[14].meta.general.method.padEnd(4, '.') + "")) set_data_dev(t2, t2_value);

  			if (!current || dirty & /*lst, obj*/ 3 && span1_class_value !== (span1_class_value = "sv-" + /*i2*/ ctx[14].meta.general.method + " svelte-1mbw9mc")) {
  			...
  			if (!current || dirty & /*path*/ 8 && span2_class_value !== (span2_class_value = "sv-" + (/*path*/ ctx[3] ? 'path' : 'fullpath') + " svelte-1mbw9mc")) {
  			...
  			if (!current || dirty & /*lst, obj*/ 3 && summary0_class_value !== (summary0_class_value = "sv-title st" + Math.trunc(/*i2*/ ctx[14].meta.general.status / 100) + "x" + " svelte-1mbw9mc")) {
  ...
  function create_each_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			if_block.c();
  			t5 = space();
  			attr_dev(span, "class", "sv-total svelte-1mbw9mc");
  			add_location(span, file, 78, 20, 2235);
  			attr_dev(summary, "class", "svelte-1mbw9mc");
  			add_location(summary, file, 77, 4, 2204);
  			attr_dev(details, "class", "sv-session");
  			attr_dev(details, "data-ss", details_data_ss_value = /*item*/ ctx[11].session);
  			add_location(details, file, 76, 2, 2126);
  		},
  		m: function mount(target, anchor) {
  			insert_dev(target, details, anchor);
  			append_dev(details, summary);
  ...
  function create_fragment(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(b, file, 65, 0, 1781);
  			attr_dev(input0, "type", "checkbox");
  			attr_dev(input0, "id", "sv-body");
  			attr_dev(input0, "class", "svelte-1mbw9mc");
  			add_location(input0, file, 67, 2, 1825);
  			attr_dev(label0, "for", "sv-body");
  			add_location(label0, file, 66, 0, 1802);
  			attr_dev(input1, "type", "checkbox");
  			attr_dev(input1, "id", "sv-no-host");
  			attr_dev(input1, "class", "svelte-1mbw9mc");
  			add_location(input1, file, 70, 2, 1925);
  			attr_dev(label1, "for", "sv-no-host");
  			add_location(label1, file, 69, 0, 1899);
  			attr_dev(input2, "type", "checkbox");
  			attr_dev(input2, "id", "sv-query");
  			attr_dev(input2, "class", "svelte-1mbw9mc");
  			add_location(input2, file, 73, 2, 2025);
  			attr_dev(label2, "for", "sv-query");
  			add_location(label2, file, 72, 0, 2001);
  			add_location(div, file, 64, 0, 1774);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
