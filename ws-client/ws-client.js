...
.bgroup-right button {
  ...
  function create_each_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(td0, file, 111, 8, 2870);
  			attr_dev(td1, "class", "kcode svelte-9jgfbz");
  			add_location(td1, file, 112, 8, 2905);
  			attr_dev(td2, "class", "key svelte-9jgfbz");
  			add_location(td2, file, 115, 8, 3012);
  			attr_dev(td3, "class", "title svelte-9jgfbz");
  			add_location(td3, file, 116, 8, 3055);
  			attr_dev(tr, "class", "svelte-9jgfbz");
  			add_location(tr, file, 110, 6, 2856);
  		},
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(110:4) {#each _keys as obj,i}",
  		ctx
  	});
  ...
  function create_fragment(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(b, file, 107, 2, 2793);
  			attr_dev(table, "class", "svelte-9jgfbz");
  			add_location(table, file, 108, 2, 2813);
  			attr_dev(div, "class", "vbox svelte-9jgfbz");
  			add_location(div, file, 106, 0, 2771);
  		},
  ...
  function kcode(obj) {
  	...
  	if (typ === "key") {
  		...
  		if (qctl) {
  			msg = `[ctl]......+\`${qctl[1].substr(-1)}\``;
  		} else if (qalt) {
  			msg = `[alt]......+\`${qalt[1].substr(-1)}\``;
  		} else {
  			msg = `[ctl]+[alt]+\`${arr.pop()}\``;
  		}
  	} else if (typ === "code") {
