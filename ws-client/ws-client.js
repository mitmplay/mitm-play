...
.bgroup-topr span {
  font-size: 14px;
	...
	function create_fragment$4(ctx) {
		...
		const block = {
			c: function create() {
				div = element("div");
				h4 = element("h4");
				h4.textContent = `${/*axeHelp*/ ctx[3]}`;
				t1 = space();
				p0 = element("p");
				p0.textContent = `${/*axeDesc*/ ctx[1]}`;
				t3 = space();
				p1 = element("p");
				b0 = element("b");
				b0.textContent = "tags:";
				t5 = space();
				t6 = text(/*axeTags*/ ctx[6]);
				t7 = space();
				p2 = element("p");
				b1 = element("b");
				b1.textContent = "impact:";
				t9 = space();
				t10 = text(/*axeImpact*/ ctx[5]);
				t11 = space();
				p3 = element("p");
				b2 = element("b");
				b2.textContent = "link:";
				t13 = space();
				a = element("a");
				t14 = text(/*axeGrp*/ ctx[2]);
				add_location(h4, file$4, 30, 2, 858);
				add_location(p0, file$4, 31, 2, 879);
				add_location(b0, file$4, 32, 5, 901);
				add_location(p1, file$4, 32, 2, 898);
				add_location(b1, file$4, 33, 5, 933);
				add_location(p2, file$4, 33, 2, 930);
				add_location(b2, file$4, 34, 5, 969);
				attr_dev(a, "href", /*axeHelper*/ ctx[4]);
				add_location(a, file$4, 34, 18, 982);
				add_location(p3, file$4, 34, 2, 966);
				attr_dev(div, "class", "a11y-popup svelte-1tcrfs8");
				attr_dev(div, "style", /*style*/ ctx[0]);
				add_location(div, file$4, 28, 0, 822);
			},
	...
	function instance$4($$self, $$props, $$invalidate) {
		...
		const { axeDesc, axeGrp, axeHelp, axeHelper, axeImpact, axeTags, axeTarget } = node.dataset;
		...
		return [style, axeDesc, axeGrp, axeHelp, axeHelper, axeImpact, axeTags, node];
	}

	class A11yPopup$1 extends SvelteComponentDev {
		constructor(options) {
			super(options);
			init(this, options, instance$4, create_fragment$4, safe_not_equal, { node: 7 });
			...
			if (/*node*/ ctx[7] === undefined && !('node' in props)) {
