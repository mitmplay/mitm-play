...
.bgroup-right button {
  ...
  function create_each_block(ctx) {
  	...
  	let t1;
  	let td1;
  	let t2_value = /*obj*/ ctx[2].id + "";
  	let t2;
  	let t3;
  	let td2;
  	let t4_value = /*obj*/ ctx[2].title + "";
  	let t4;
  	let t5;
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(td0, file, 25, 8, 466);
  			attr_dev(td1, "class", "kcode svelte-1ucdyll");
  			add_location(td1, file, 26, 8, 501);
  			attr_dev(td2, "class", "title svelte-1ucdyll");
  			add_location(td2, file, 27, 8, 542);
  			add_location(tr, file, 24, 6, 452);
  		},
  		...
  		p: function update(ctx, dirty) {
  			if (dirty & /*_keys*/ 1 && t2_value !== (t2_value = /*obj*/ ctx[2].id + "")) set_data_dev(t2, t2_value);
  			if (dirty & /*_keys*/ 1 && t4_value !== (t4_value = /*obj*/ ctx[2].title + "")) set_data_dev(t4, t4_value);
  		},
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(24:4) {#each _keys as obj,i}",
  		ctx
  	});
  ...
  function create_fragment(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(b, file, 21, 2, 389);
  			attr_dev(table, "class", "svelte-1ucdyll");
  			add_location(table, file, 22, 2, 409);
