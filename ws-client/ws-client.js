...
.bgroup-right button {
  ...
  function create_if_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			t2 = space();
  			attr_dev(summary, "class", "svelte-1jr26wm");
  			add_location(summary, file$1, 39, 15, 1003);
  			add_location(details, file$1, 39, 6, 994);
  		},
  ...
  function create_else_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			t6 = text("v");
  			t7 = text(t7_value);
  			add_location(small, file$1, 43, 39, 1209);
  		},
  		m: function mount(target, anchor) {
  		...
  		p: function update(ctx, dirty) {
  			if (dirty & /*csp*/ 1 && t4_value !== (t4_value = /*csp*/ ctx[0][/*id*/ ctx[1]].length + "")) set_data_dev(t4, t4_value);
  		},
  		d: function destroy(detaching) {
  ...
  function create_if_block_2(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(a, file$1, 41, 16, 1062);
  			add_location(small, file$1, 41, 70, 1116);
  		},
  		m: function mount(target, anchor) {
  			insert_dev(target, t0, anchor);
  			insert_dev(target, t1, anchor);
  		...
  		p: function update(ctx, dirty) {
  			if (dirty & /*csp*/ 1 && t5_value !== (t5_value = /*csp*/ ctx[0][/*id*/ ctx[1]].length + "")) set_data_dev(t5, t5_value);
  		},
  		d: function destroy(detaching) {
  			if (detaching) detach_dev(t0);
  			if (detaching) detach_dev(t1);
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "if",
  		source: "(41:8) {#if cspInfo[id].link}",
  		ctx
  	});
  ...
  function create_if_block_1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			small = element("small");
  			attr_dev(summary, "class", "svelte-1jr26wm");
  			add_location(summary, file$1, 47, 32, 1343);
  			add_location(small, file$1, 48, 12, 1385);
  			attr_dev(details, "class", "note svelte-1jr26wm");
  			add_location(details, file$1, 47, 10, 1321);
  		},
  		m: function mount(target, anchor) {
  			insert_dev(target, details, anchor);
  			append_dev(details, summary);
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "if",
  		source: "(47:8) {#if cspInfo[id].note}",
  		ctx
  	});
  ...
  function create_each_block_1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			t1 = text(":");
  			t2 = text(t2_value);
  			attr_dev(div, "class", "item svelte-1jr26wm");
  			add_location(div, file$1, 52, 10, 1509);
  		},
  		m: function mount(target, anchor) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(52:8) {#each csp[id] as item, x}",
  		ctx
  	});
  ...
  function create_each_block$1(ctx) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(38:4) {#each cspArr as id, i}",
  		ctx
  	});
  	...
  	onMount(async () => {
  		if (csp["default-src"].length > 1) {
  			...
  			for (const id of Cspdirective.cspFetch) {
  				if (!csp[id]) {
  					$$invalidate(0, csp[id] = ["*fallback*", ...fallback], csp);
  				}
  			}
  		}
  		...
  		for (const id of Cspdirective.cspEAttr) {
  			...
  			if (!csp[id] && csp[par]) {
  				$$invalidate(0, csp[id] = csp[par], csp);
  			}
  		}
  	});
