...
.bgroup-right button {
  ...
  function create_each_block(ctx) {
  	...
  	let t1;
  	let td1;
  	let t2_value = /*obj*/ ctx[4].id.match(/\w+:(.+)/)[1] + "";
  	let t2;
  	let t3;
  	let td2;
  	let t4_value = kcode(/*obj*/ ctx[4]) + "";
  	let t4;
  	let t5;
  	let td3;
  	let t6_value = /*obj*/ ctx[4].title + "";
  	let t6;
  	let t7;
  	let mounted;
  	let dispose;
  	...
  	const block = {
  		c: function create() {
  			...
  			t6 = text(t6_value);
  			t7 = space();
  			attr_dev(td0, "class", "no svelte-9jgfbz");
  			add_location(td0, file, 139, 8, 3319);
  			attr_dev(td1, "class", "kcode svelte-9jgfbz");
  			add_location(td1, file, 140, 8, 3354);
  			attr_dev(td2, "class", "key svelte-9jgfbz");
  			add_location(td2, file, 143, 8, 3461);
  			attr_dev(td3, "class", "title svelte-9jgfbz");
  			add_location(td3, file, 144, 8, 3504);
  			attr_dev(tr, "class", "svelte-9jgfbz");
  			add_location(tr, file, 138, 6, 3305);
  		},
  		...
  		p: function update(ctx, dirty) {
  			if (dirty & /*_keys*/ 1 && t2_value !== (t2_value = /*obj*/ ctx[4].id.match(/\w+:(.+)/)[1] + "")) set_data_dev(t2, t2_value);
  			if (dirty & /*_keys*/ 1 && t4_value !== (t4_value = kcode(/*obj*/ ctx[4]) + "")) set_data_dev(t4, t4_value);
  			if (dirty & /*_keys*/ 1 && t6_value !== (t6_value = /*obj*/ ctx[4].title + "")) set_data_dev(t6, t6_value);
  		},
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(138:4) {#each _keys as obj,i}",
  		ctx
  	});
  ...
  function create_fragment(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(b, file, 135, 2, 3242);
  			attr_dev(table, "class", "svelte-9jgfbz");
  			add_location(table, file, 136, 2, 3262);
  			attr_dev(div, "class", "vbox svelte-9jgfbz");
  			add_location(div, file, 134, 0, 3220);
  		},
  		...
  		p: function update(ctx, [dirty]) {
  			if (dirty & /*_keys, kcode, handleClick*/ 1) {
