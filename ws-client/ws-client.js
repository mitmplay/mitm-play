...
.bgroup-right button {
  ...
  function create_if_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(summary, file$1, 42, 15, 1085);
  			add_location(details, file$1, 42, 6, 1076);
  		},
  ...
  function create_else_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			t6 = text("v");
  			t7 = text(t7_value);
  			add_location(small, file$1, 46, 46, 1348);
  		},
  		m: function mount(target, anchor) {
  ...
  function create_if_block_2(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			t6 = text("v");
  			t7 = text(t7_value);
  			add_location(small, file$1, 44, 73, 1244);
  			attr_dev(a, "href", Cspdirective.cspInfo[/*id*/ ctx[2]].link);
  			add_location(a, file$1, 44, 46, 1217);
  		},
  		m: function mount(target, anchor) {
  			insert_dev(target, t0, anchor);
  			insert_dev(target, t1, anchor);
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "if",
  		source: "(44:8) {#if cspInfo[id].link}",
  		ctx
  	});
  ...
  function create_if_block_1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(summary, file$1, 50, 32, 1482);
  			add_location(small, file$1, 51, 12, 1524);
  			attr_dev(details, "class", "note svelte-ws3cmd");
  			add_location(details, file$1, 50, 10, 1460);
  		},
  		m: function mount(target, anchor) {
  			insert_dev(target, details, anchor);
  			append_dev(details, summary);
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "if",
  		source: "(50:8) {#if cspInfo[id].note}",
  		ctx
  	});
  ...
  // (55:8) {#each csp[id].policy as item, x}
  function create_each_block_1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(div, file$1, 55, 10, 1655);
  		},
  		m: function mount(target, anchor) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(55:8) {#each csp[id].policy as item, x}",
  		ctx
  	});
  ...
  function create_each_block$1(ctx) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(41:4) {#each cspArr as id, i}",
  		ctx
  	});
  ...
  function create_fragment$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			t16 = space();
  			div0 = element("div");
  			div0.textContent = `${/*reportTo*/ ctx[1]}`;
  			add_location(b0, file$1, 32, 2, 654);
  			attr_dev(a0, "href", "https://developer.mozilla.org/en-US/docs/Web/HTTP/CSP");
  			add_location(a0, file$1, 35, 4, 710);
  			attr_dev(a1, "href", "https://content-security-policy.com/");
  			add_location(a1, file$1, 36, 4, 793);
  			attr_dev(a2, "href", "https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html");
  			add_location(a2, file$1, 37, 4, 878);
  			add_location(p, file$1, 33, 2, 688);
  			add_location(hr, file$1, 60, 4, 1756);
  			add_location(b1, file$1, 61, 37, 1801);
  			attr_dev(summary0, "class", "report svelte-ws3cmd");
  			add_location(summary0, file$1, 61, 13, 1777);
  			attr_dev(summary1, "class", "svelte-ws3cmd");
  			add_location(summary1, file$1, 62, 28, 1858);
  			add_location(small, file$1, 63, 8, 1896);
  			attr_dev(details0, "class", "note svelte-ws3cmd");
  			add_location(details0, file$1, 62, 6, 1836);
  			attr_dev(div0, "class", "item svelte-ws3cmd");
  			add_location(div0, file$1, 65, 6, 2130);
  			add_location(details1, file$1, 61, 4, 1768);
  			add_location(div1, file$1, 39, 2, 1009);
  			attr_dev(div2, "class", "vbox");
  			add_location(div2, file$1, 31, 0, 632);
  		},
