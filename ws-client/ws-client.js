...
.bgroup-right button {
  ...
  function create_if_block$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(summary, file$2, 49, 15, 1393);
  			add_location(details, file$2, 49, 6, 1384);
  		},
  ...
  function create_else_block$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			t6 = text("v");
  			t7 = text(t7_value);
  			add_location(small, file$2, 53, 46, 1656);
  		},
  		m: function mount(target, anchor) {
  ...
  function create_if_block_2(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			t6 = text("v");
  			t7 = text(t7_value);
  			add_location(small, file$2, 51, 73, 1552);
  			attr_dev(a, "href", Cspdirective.cspInfo[/*id*/ ctx[2]].link);
  			add_location(a, file$2, 51, 46, 1525);
  		},
  		m: function mount(target, anchor) {
  			insert_dev(target, t0, anchor);
  			insert_dev(target, t1, anchor);
  ...
  function create_if_block_1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(summary, file$2, 57, 32, 1790);
  			add_location(small, file$2, 58, 12, 1832);
  			attr_dev(details, "class", "note svelte-ws3cmd");
  			add_location(details, file$2, 57, 10, 1768);
  		},
  		m: function mount(target, anchor) {
  			insert_dev(target, details, anchor);
  			append_dev(details, summary);
  ...
  function create_each_block_1$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(div, file$2, 62, 10, 1963);
  		},
  		m: function mount(target, anchor) {
  ...
  function create_fragment$2(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(b0, file$2, 39, 2, 962);
  			attr_dev(a0, "href", "https://developer.mozilla.org/en-US/docs/Web/HTTP/CSP");
  			add_location(a0, file$2, 42, 4, 1018);
  			attr_dev(a1, "href", "https://content-security-policy.com/");
  			add_location(a1, file$2, 43, 4, 1101);
  			attr_dev(a2, "href", "https://cheatsheetseries.owasp.org/cheatsheets/Content_Security_Policy_Cheat_Sheet.html");
  			add_location(a2, file$2, 44, 4, 1186);
  			add_location(p, file$2, 40, 2, 996);
  			add_location(hr, file$2, 67, 4, 2064);
  			add_location(b1, file$2, 68, 37, 2109);
  			attr_dev(summary0, "class", "report svelte-ws3cmd");
  			add_location(summary0, file$2, 68, 13, 2085);
  			attr_dev(summary1, "class", "svelte-ws3cmd");
  			add_location(summary1, file$2, 69, 28, 2166);
  			add_location(small, file$2, 70, 8, 2204);
  			attr_dev(details0, "class", "note svelte-ws3cmd");
  			add_location(details0, file$2, 69, 6, 2144);
  			attr_dev(div0, "class", "item svelte-ws3cmd");
  			add_location(div0, file$2, 72, 6, 2438);
  			add_location(details1, file$2, 68, 4, 2076);
  			add_location(div1, file$2, 46, 2, 1317);
  			attr_dev(div2, "class", "vbox");
  			add_location(div2, file$2, 38, 0, 940);
  		},
  ...
  // (69:4) {#if lst[item.session].length}
  function create_if_block(ctx) {
  	...
  	const block = {
  		...
  		p: function update(ctx, dirty) {
  			if (dirty & /*lst, obj, expClick, host, path, srch*/ 207) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "if",
  		source: "(69:4) {#if lst[item.session].length}",
  		ctx
  	});
  ...
  // (70:6) {#each lst[item.session] as i2}
  function create_each_block_1(ctx) {
  	let details2;
  	let summary0;
  	let t0_value = /*host*/ ctx[7](/*i2*/ ctx[14].url, /*path*/ ctx[2], /*srch*/ ctx[3]) + "";
  	let t0;
  	...
  	const block = {
  		c: function create() {
  			...
  			t8 = text(t8_value);
  			t9 = space();
  			attr_dev(summary0, "class", "title svelte-fjlr5a");
  			...
  			add_location(summary0, file, 71, 10, 1873);
  			add_location(summary1, file, 75, 12, 2069);
  			attr_dev(pre0, "class", "svelte-fjlr5a");
  			add_location(pre0, file, 76, 12, 2108);
  			attr_dev(details0, "class", "row-data svelte-fjlr5a");
  			add_location(details0, file, 74, 10, 2029);
  			add_location(summary2, file, 79, 12, 2202);
  			attr_dev(pre1, "class", "svelte-fjlr5a");
  			add_location(pre1, file, 80, 12, 2242);
  			attr_dev(details1, "class", "row-data svelte-fjlr5a");
  			add_location(details1, file, 78, 10, 2162);
  			attr_dev(details2, "class", "rows svelte-fjlr5a");
  			add_location(details2, file, 70, 8, 1839);
  		},
  		m: function mount(target, anchor) {
  			insert_dev(target, details2, anchor);
  			append_dev(details2, summary0);
  			append_dev(summary0, t0);
  			append_dev(details2, t1);
  		...
  		p: function update(ctx, dirty) {
  			if (dirty & /*lst, obj, path, srch*/ 15 && t0_value !== (t0_value = /*host*/ ctx[7](/*i2*/ ctx[14].url, /*path*/ ctx[2], /*srch*/ ctx[3]) + "")) set_data_dev(t0, t0_value);

  			if (dirty & /*lst, obj*/ 3 && summary0_data_id_value !== (summary0_data_id_value = /*i2*/ ctx[14].id)) {
  				attr_dev(summary0, "data-id", summary0_data_id_value);
  			}

  			if (dirty & /*obj*/ 2 && summary0_data_ss_value !== (summary0_data_ss_value = /*item*/ ctx[11].session)) {
  				attr_dev(summary0, "data-ss", summary0_data_ss_value);
  			}

  			if (dirty & /*lst, obj*/ 3 && t4_value !== (t4_value = /*i2*/ ctx[14].meta + "")) set_data_dev(t4, t4_value);
  			if (dirty & /*lst, obj*/ 3 && t8_value !== (t8_value = /*i2*/ ctx[14].data + "")) set_data_dev(t8, t8_value);
  		},
  		d: function destroy(detaching) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(70:6) {#each lst[item.session] as i2}",
  		ctx
  	});
  ...
  function create_each_block(ctx) {
  	...
  	function select_block_type(ctx, dirty) {
  		if (/*lst*/ ctx[0][/*item*/ ctx[11].session].length) return create_if_block;
  	...
  	const block = {
  		...
  		p: function update(ctx, dirty) {
  			if (dirty & /*obj*/ 2 && t0_value !== (t0_value = /*item*/ ctx[11].session + "")) set_data_dev(t0, t0_value);
  			...
  			if (dirty & /*obj*/ 2 && details_data_ss_value !== (details_data_ss_value = /*item*/ ctx[11].session)) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(64:0) {#each obj.rows as item}",
  		ctx
  	});
  ...
  function create_fragment(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(b, file, 53, 0, 1307);
  			attr_dev(input0, "type", "checkbox");
  			attr_dev(input0, "id", "no-host");
  			attr_dev(input0, "class", "svelte-fjlr5a");
  			add_location(input0, file, 55, 2, 1351);
  			attr_dev(label0, "for", "no-host");
  			add_location(label0, file, 54, 0, 1328);
  			attr_dev(input1, "type", "checkbox");
  			attr_dev(input1, "id", "srch");
  			attr_dev(input1, "class", "svelte-fjlr5a");
  			add_location(input1, file, 58, 2, 1444);
  			attr_dev(label1, "for", "srch");
  			add_location(label1, file, 57, 0, 1424);
  			attr_dev(input2, "type", "checkbox");
  			attr_dev(input2, "id", "body");
  			attr_dev(input2, "class", "svelte-fjlr5a");
  			add_location(input2, file, 61, 2, 1531);
  			attr_dev(label2, "for", "body");
  			add_location(label2, file, 60, 0, 1511);
  			add_location(div, file, 52, 0, 1300);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
  		...
  		p: function update(ctx, [dirty]) {
  			...
  			if (dirty & /*obj, detailClick, lst, expClick, host, path, srch*/ 239) {
